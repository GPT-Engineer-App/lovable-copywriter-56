...
const PostGenerator = ({ historicalPosts }) => {
  ...
  const generatePost = () => {
    ...
    const systemPrompt = "Read the historical posts and based on that write or rewrite posts that the user asks for. Don't use hashtags, keep it modern and non-salesy:\n\n";
